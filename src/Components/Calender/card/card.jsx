    ...
    <div className="card card-cal" >
        ...
        <div className="card-body">
            <div className='row textContainer mb-1'>
                <h5 className="card-title header--card-home fw-bold lh-sm text-start">{item.title_en}</h5>
                <p className="card-text paragraph--card-home fw-normal lh-base text-start">{item.short_desc_en}</p> 
                <hr/>   
